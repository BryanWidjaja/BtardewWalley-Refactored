...
public class GameMaps {
	public static int MAP_WIDTH = 44;
	public static int MAP_HEIGHT = 21;

	public static char[][] HOME_MAP = {
		"############################################".toCharArray(),
		"#                                          #".toCharArray(),
		"#                 `'::::,                  #".toCharArray(),
		"#                   ____||_                #".toCharArray(),
	...
	public static char[][] ANIMAL_FARM_MAP = {
		"############################################".toCharArray(),
		"####                        ##           ###".toCharArray(),
		"###   #                    #              ##".toCharArray(),
		"#      #                             ##    #".toCharArray(),
	...
	public static char[][] PLANT_FARM_MAP = {
		"############################################".toCharArray(),
		"##   ###########       _____        ########".toCharArray(),
		"#      #####          /    /\\____       ####".toCharArray(),
